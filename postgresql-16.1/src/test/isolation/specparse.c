...
#line 1167 "specparse.c"
    break;

  case 5: /* opt_setup: %empty  */
#line 90 "specparse.y"
                                                        { (yyval.str) = NULL; }
#line 1173 "specparse.c"
    break;

  case 6: /* opt_setup: setup  */
#line 91 "specparse.y"
                                                        { (yyval.str) = (yyvsp[0].str); }
#line 1179 "specparse.c"
    break;

  case 7: /* setup: SETUP sqlblock  */
#line 95 "specparse.y"
                                                { (yyval.str) = (yyvsp[0].str); }
#line 1185 "specparse.c"
    break;

...
#define CONFIGURE_ARGS " '--prefix=/home/shf/pg/postgresql-16.1/release/bin' '--with-zlib' '--enable-debug' '--without-icu' 'CCFLAG=-g -O0' 'CC=gcc'"
...
#define PG_VERSION_STR "PostgreSQL 16.1 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 13.2.0-23ubuntu4) 13.2.0, 64-bit"

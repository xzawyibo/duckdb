...
char *duckdb_motherduck_session_hint = "";
char *duckdb_postgres_role = "";
bool duckdb_force_motherduck_views = false;

int duckdb_maximum_threads = -1;
int duckdb_maximum_memory = 4096;
char *duckdb_disabled_filesystems = "";
...
char *duckdb_default_collation = "";
char *duckdb_azure_transport_option_type = "";
char *duckdb_custom_user_agent = "";
*/
